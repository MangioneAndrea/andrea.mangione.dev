...
pub fn stack() -> impl IntoView {
    view! {
        <div>
            <h2 class="font-title">My stack</h2>
            <div class="flex flex-col lg:flex-row justify-evenly">
                <p class=" lg:w-[30%] text-center content-center">
                    ...
                    <br />
                    The only ones I would use if starting from scratch are the simpler ones which will not cause 20000 rerender because one made an effect too much ... <br/>
                    ...This website is powered by leptos btw. :D
                </p>
            ...
            <div class="flex flex-col lg:flex-row justify-evenly">
                <p class=" lg:w-[30%] text-center content-center">
                But computer sience is way way more!
                <br/>
